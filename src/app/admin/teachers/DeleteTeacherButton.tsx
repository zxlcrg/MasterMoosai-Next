...
export function DeleteTeacherButton({ id, name }: { id: number; name: string }) {
  ...
  async function handleDelete() {
    ...
    else { toast.success("Teacher deleted."); router.refresh(); }
    setOpen(false);
  }
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-xl shadow-xl max-w-md w-full mx-4 p-6">
            ...
            <p className="text-sm text-gray-500 mb-6">Delete <span className="font-semibold">{name}</span>? This cannot be undone.</p>
