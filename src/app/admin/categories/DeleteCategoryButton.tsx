...
export function DeleteCategoryButton({ id, name, courseCount }: { id: number; name: string; courseCount: number }) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-xl shadow-xl max-w-md w-full mx-4 p-6">
            ...
            <p className="text-sm text-gray-500 mb-6">
              ...
              {courseCount > 0 && <> {courseCount} course(s) currently use this category — they will be unassigned (not deleted).</>}
            </p>
